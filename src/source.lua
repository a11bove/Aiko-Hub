...
pcall(
    function()
        LucideIcons =
            loadstring(game:HttpGet("https://raw.githubusercontent.com/a11bove/kdoaz/refs/heads/main/src/icons.lua"))()
    end
)
    ...
    function Tabs:CreateTab(TabConfig)
        ...
        function Sections:AddSection(Title)
            ...
            function Items:AddButton(ButtonConfig)
                ...
                ButtonButton.MouseButton1Click:Connect(
                    function()
            ...
            function Items:AddToggle(ToggleConfig)
                ...
                local ToggleFunc = {
                    ...
                    Selecting = ToggleConfig.Selecting
                }
                ...
                ToggleContent:GetPropertyChangedSignal("AbsoluteSize"):Connect(
                    function()
