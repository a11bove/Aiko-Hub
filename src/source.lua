...
if not isfolder("aikoware/config") then
    makefolder("aikoware/config")
end
...
local ConfigFile = "aikoware/config/aiko_" .. gameName .. ".json"
...
if InputConfig.Content == "" or InputConfig.Content == nil then
    ...
    InputContent.Visible = false
                ...
                InputTextBox.Text = InputConfig.Default or ""
                ...
                SearchBar:GetPropertyChangedSignal("Text"):Connect(function()
                    ...
                    for _, option in pairs(ScrollSelect:GetChildren()) do
                        if option:IsA("Frame") and option.Name == "Option" then
                            local optionText = string.lower(option:FindFirstChild("OptionText").Text)
                    ...
                    for _, child in ScrollSelect:GetChildren() do
                        if child.Name == "Option" and child.Visible then
                            OffsetY = OffsetY + 33
                        elseif child.Name == "SearchContainer" then
                            OffsetY = OffsetY + child.Size.Y.Offset + 3
                        end
                    end
