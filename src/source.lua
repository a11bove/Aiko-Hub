...
local function MakeDraggable(topbarobject, object)
	...
	local function CustomSize(object)
         ...
         local DragStart = nil
	     local StartSize = nil
	     local maxSizeX = 480  -- CHANGE THIS: was 500, this is your MINIMUM width
	     local maxSizeY = 300  -- CHANGE THIS: was 400, this is your MINIMUM height
...
function FlurioreLib:MakeGui(GuiConfig)
	...
	DropShadowHolder.BackgroundTransparency = 0.5
	DropShadowHolder.BorderSizePixel = 0
	...
	DecideUICorner.CornerRadius = UDim.new(0, 6)
    ...
    local finalWidth = math.max(calculatedWidth, 480)  -- Minimum 500 width
...
if InputConfig.Content == "" or InputConfig.Content == nil then
	...
	-- THIS IS THE KEY FIX - Create wrapper page
	...
	DropdownPage.Name = "DropdownPage_" .. CountDropdown
	DropdownPage.Parent = DropdownFolder
	
	print("Created DropdownPage with LayoutOrder:", CountDropdown) -- DEBUG
	...
	DropdownButton.MouseButton1Click:Connect(function()
		...
		if not MoreBlur.Visible then
			...
			print("Jumping to index:", CountDropdown) -- DEBUG
		...
		for _, Drop in ScrollSelect:GetChildren() do
			if Drop.Name == "Option" then
				...
				if isSelected then
					...
					TweenService:Create(Drop, TweenInfo.new(0.2), {BackgroundTransparency = 0.5}):Play()
				else
	...
	function DropdownFunc:AddOption(OptionName)
		...
		Option.BackgroundColor3 = GuiConfig.Color
		...
		print("Added option:", OptionName, "to ScrollSelect") -- DEBUG
		...
		ScrollSelect.CanvasSize = UDim2.new(0, 0, 0, OffsetY)
		print("Canvas size updated to:", OffsetY) -- DEBUG
...
--[[function Items:AddDropdown(DropdownConfig)
	...
	function DropdownFunc:AddOption(OptionName)
		...
		Option.BackgroundColor3 = GuiConfig.Color  -- CHANGED: Use GuiConfig color
		Option.BackgroundTransparency = 1
		Option.BorderColor3 = Color3.fromRGB(0, 0, 0)
		Option.BorderSizePixel = 0
		Option.LayoutOrder = DropCount
